...
# Check if there are fewer than 5 rows in similar_data
sample_size = min(5, len(similar_data))  # Take the minimum of 5 or the number of rows available

# Display the sample
st.write(similar_data.sample(sample_size))
